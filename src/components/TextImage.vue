...
export default {
    ...
    data() {
        return {
            ...
            fonts: [{text: 'Select One', value: null}, 
                    'AlegreyaSC', 'ABeeZee', 'AmaticSC', 'Bangers', 'BungeeShade',
                    'ChelseaMarket', 'Courgette', 'DancingScript', 'Lato Black',
                    'LifeSavers', 'Lora', 'Montserrat', 'PassionOne', 'PlayfairDisplay',
                    'SourceSansPro'],
            types: [{text: 'Solid', value: 'solid'}, {text: 'Gradient', value: 'gradient'}],
            gradients: [{text: 'Linear Gradient', value: 'linear'}, {text: 'Radial Gradient', value: 'radial'}],
            animate: [{text: 'None', value: 'none'}, {text: 'Light Rays', value: 'rays'}, {text: 'Glint', value: 'glint'}, {text: 'Circles', value: 'circle'}]
        }
    },  
    methods: {
        reset: function(){
